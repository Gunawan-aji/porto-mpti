...
$portfolio = [
    ['title' => 'Kopi Kenangan', 'desc' => 'Kopi Kenangan: Website kafe kopi modern dengan menu lengkap, POS kasir, admin panel, dan galeri cozy. Nikmati kopi berkualitas!', 'img' => 'assets/images/web2.png', 'category' => 'websites & sistem', 'url' => '../web/kopi-kenangan/index.php', 'full_desc' => ''],
    ['title' => 'Outdoor Adventure', 'desc' => 'Situs Outdoor Adventure: sewa alat outdoor berkualitas, open trip hiking/camping gunung populer Indonesia dengan guide profesional.', 'img' => 'assets/images/web3.png', 'category' => 'websites', 'url' => '../web/outdoor/index.php', 'full_desc' => ''],
