...
<head>
    ...
    <title>Menu - <?= $settings['site_name'] ?></title>
    <meta name="description" content="Menu lengkap Kopi Kenangan - Berbagai pilihan kopi dan makanan">
...
<body>
    ...
    <!-- Menu Section -->
    <section class="section menu" style="background: var(--light);">
        <div class="container">
            <!-- Category Filter -->
            <div class="menu-categories" style="margin-bottom: 40px;">
                    ...
                    <div class="menu-card" data-category="<?= $product['kategori_id'] ?>">
                        ...
                        <div class="menu-content">
                            ...
                            <div class="menu-card-actions">
                                ...
                                <a href="product-detail.php?id=<?= $product['id'] ?>" class="menu-btn"
            ...
            <?php if (empty($products)): ?>
                <div style="text-align: center; padding: 60px 20px;">
                    <i class="fas fa-coffee" style="font-size: 4rem; color: var(--gray-300); margin-bottom: 20px;"></i>
                    <h3 style="margin-bottom: 10px;">Menu tidak ditemukan</h3>
