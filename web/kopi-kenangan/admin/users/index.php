...
<body>
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            <a href="../users/index.php" class="menu-item active"><i class="fas fa-users"></i><span>Karyawan</span></a>
                        ...
                        <tbody>
                            <?php foreach ($users as $index => $user): ?>
                                <tr>
                                    ...
                                    <td><span class="status-badge <?= $user['role'] ?>">
                                            <?= ucfirst($user['role']) ?>
                                        </span></td>
                                    ...
                                    <td>
                                        <div class="action-btns">
                                            <a href="edit.php?id=<?= $user['id'] ?>" class="btn-action btn-edit"
