...
<head>
    ...
    <title>Kelola Produk - Admin <?= $settings['site_name'] ?></title>
                        ...
                        <tbody>
                            <?php foreach ($products as $index => $product): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            style="width: 50px; height: 50px; background: linear-gradient(135deg, #8D6E63, #C4A77D); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: white;">
                                    ...
                                    <td>
                                        <div class="action-btns">
                                            ...
                                            <a href="index.php?delete=<?= $product['id'] ?>" class="btn-action btn-delete"
                                                title="Hapus" onclick="return confirm('Yakin hapus produk ini?')">
